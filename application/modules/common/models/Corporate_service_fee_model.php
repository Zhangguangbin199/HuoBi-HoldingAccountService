...
class Corporate_service_fee_model extends Base_Model implements ICorporateServiceFeeMapper{
    ...
    public function insert(CorporateServiceFee $serv){
        ...
        if( $this->db->insert('iafb_holding_account.corporate_service_fee') )
        {
            return true;
        }
    ...
    public function findById($id, $deleted = false){
        ...
        $this->db->from('iafb_holding_account.corporate_service_fee');
        $this->db->where('id', $id);
        if(!$deleted) 
        {
    ...
    public function update(CorporateServiceFee $CorporateServiceFee){
        ...
        if( $this->db->update('iafb_holding_account.corporate_service_fee') )
        {
            return true;
        }
