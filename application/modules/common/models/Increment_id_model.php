...
class increment_id_model extends Base_Model implements IIncrementIDMapper{
    ...
    function __construct()
    {
        ...
        $this->inc_db = $this->load->database('iafb_holding_account', true);
    }
    ...
    public function findById($id, $deleted = false)
    {
        $this->inc_db->select('id as increment_table_id,
                               ...
                               deleted_at,
                               deleted_by');
        $this->inc_db->from('iafb_holding_account.increment_table');
        if(!$deleted)
        {
    ...
    public function findByAttribute($attribute)
    {
        $query = $this->inc_db->query("SELECT
                                       ...
                                       deleted_at,
                                       deleted_by
                                       FROM iafb_holding_account.increment_table where attribute = '"
                                        . $attribute . "'
    ...
    public function updateIncrementNumber(IncrementID $data)
    {
        ...
        if ($this->inc_db->update('iafb_holding_account.increment_table'))
        {
    ...
    public function insert(IncrementID $inc)
    {
        ...
        if ($this->inc_db->insert('iafb_holding_account.increment_table'))
        {
